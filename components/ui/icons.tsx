...
export function QuoteIcon({ className = "w-8 h-8" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.29l.865 1.463a7.34 7.34 0 00-2.96 3.018c1.26.596 2.043 1.76 2.043 3.168 0 1.33-.6 2.47-1.398 3.631zM14.583 17.321c-1.03-1.094-1.583-2.321-1.583-4.31 0-3.5 2.457-6.637 6.03-8.29l.865 1.463a7.34 7.34 0 00-2.96 3.018c1.26.596 2.043 1.76 2.043 3.168 0 1.33-.6 2.47-1.398 3.631z" />
    </svg>
  );
}
...
export function AdvantageIcon({ name, className = "w-5 h-5" }: IconProps & { name: string }) {
...
export function FeatureIcon({ name, className = "w-6 h-6" }: IconProps & { name: string }) {
  const icons: Record<string, ReactNode> = {
    exam: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-4.772 4.772L10.5 9.75l3 3m0 0l3-3m-3 3V3" />
      </svg>
    ),
    graduate: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
